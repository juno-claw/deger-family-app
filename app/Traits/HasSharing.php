...
/**
 * Reusable sharing logic for controllers that manage shareable resources.
 *
...
trait HasSharing
{
     ...
     */
    protected function performShare(Request $request, Model $resource): RedirectResponse
    {
     ...
     */
    protected function performUnshare(Request $request, Model $resource): RedirectResponse
    {
        $this->authorize($this->sharingAbility(), $resource);
